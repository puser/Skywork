...
(function() {
  ...
  Annotator = (function(_super) {
	...
	Annotator.prototype.createHighlight = function(r) {
		root = this.wrapper[0];
		normed = Range.sniff(r.range).normalize(root);
		this.highlightRange(normed,'userComment userComment' + r.uID + ' userCommentID' + r.eID);
	}
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      ...
      for (_l = 0, _len4 = normedRanges.length; _l < _len4; _l++) {
		...
		if(annotation.error) $.merge(annotation.highlights, this.highlightRange(normed,'errorCheck annotator-hl'));
		else $.merge(annotation.highlights, this.highlightRange(normed));
    ...
    Annotator.prototype.checkForEndSelection = function(event) {
      ...
      if (event && this.selectedRanges.length) {
		...
		if(!annotations.length) setTimeout(function(){ $('.annotator-adder button').click(); },5);
