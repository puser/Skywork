<div id="modal-adduser-box" class="modal-wrapper" style="width: 600px;" >
	<div class="modal-box-head">
		...
		<h2>Add a Collaborator to Puentes</h2>
	</div>
	<div class="modal-box-content">
		...
		<div style="width: 200px; margin: 0 auto; ">
			<a href="#" class="btn2" style="width: 80px; float: left;" onclick="invite_collaborator(<?php echo $id; ?>); jQuery.fancybox.close(); return false; "><span>Add</span></a>
