<div id="sidebarleft">
	...
	<div id="sidemenu">
		<ul>
			...
			<li id="menu_collaboration"><a class="icon icon-cycle" onclick="$.bbq.pushState({view:'collaboration'});">Collaborate</a></li>
...
<div id="maincolumn">
	...
	<div class="actionmenu">
		<ul>
			<li class="action-save"><a onclick="save_challenge('quiet');">Save</a></li>
...
<div style="display: none;">
	<div id="modalExitChoices" style="width:380px;">
		...
		<div style="width: 335px; margin: 0 auto; ">
			<a onclick="$('#challenge_data').attr('action','/challenges/update/0/dashboard/').submit();return false;" style="float:left;width:130px;" class="btn1 btn-savecontinue aligncenter"><span class="inner">Yes, Save Current</span></a>
			<a href="/dashboard/" class="btn2 btn-savecontinue aligncenter" style="float:left;width:130px;"><span class="inner">No, Don't Save</span></a>
			<a onclick="jQuery.fancybox.close(); return false; " style="display:inline-block;padding-left:10px;padding-top:7px;">Cancel</a>
		</div>
