<div id="sidebarleft">
	...
	<div id="sidemenu" >
		<ul>
			...
			<li class="active"><a class="no-icon" href="/static_samples/student_two/">Question 2</a></li>
...
<div id="maincolumn">
	...
	<div id="puentes-answer-questions" class="box-startbridge box-answer-questions box-white rounded">
		<div id="questionContent">
			...
			<div class="box-head">
				<span class="icon2 icon2-listcountgreen">2</span>
				<h2>Question 2</h2>
				<div class="clear"></div>
			</div>
	...
	<div style="width: 80px; margin: 0 auto;">
		<a href="/static_samples/student_three/" class="btn2"><span><?php echo __('Next') ?></span></a>
	</div>
